...
Die folgende Animation zeigt das React-Frontend im Live-Betrieb. Hierbei wird ein praxistypisches Szenario demonstriert: die fehlertolerante Suche und das automatische Abfangen von leeren Abfrageergebnissen.
...
![Framework Demo](ragdemo.gif)

*Hinweis: Sollte die obige Animation nicht automatisch abspielen, befindet sich die Datei **`ragdemo.gif`** direkt im selben Ordner wie diese README und kann [hier direkt im Repository aufgerufen werden](ragdemo.gif).*
---
